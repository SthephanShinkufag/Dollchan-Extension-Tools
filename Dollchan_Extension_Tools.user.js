...
(function de_main_func_inner(scriptStorage, FormData) {
	...
	Videos.addPlayer = function (el, m, isYtube) {
		...
		if (isYtube) {
			...
			el.innerHTML = "<iframe frameborder=\"0\" allowfullscreen=\"1\" src=\"https://www.youtube.com/embed/" + id + "?" + (enableJsapi ? "enablejsapi=1&" : Cfg.addYouTube === 3 ? "autoplay=1&" : "") + (Cfg.YTubeHD ? "hd=1&" : "") + (list ? list[0] + "&" : "") + "start=" + time + (Cfg.YTubeType === 1 ? "&html5=1&rel=0\" type=\"text/html\"" : "\" type=\"application/x-shockwave-flash\"") + wh + "</iframe>" + sp;
		} else {
			time = m[2] ? m[2] : "";
	...
	var loadPages = async(regeneratorRuntime.mark(function callee$1$1(count) {
		...
		return regeneratorRuntime.wrap(function callee$1$1$(context$2$0) {
			while (1) switch (context$2$0.prev = context$2$0.next) {
				...
				case 19:
					context$2$0.prev = 19;
					context$2$0.t20 = context$2$0["catch"](12);
				...
				case 27:
					context$2$0.prev = 27;
					context$2$0.t21 = context$2$0["catch"](23);
				...
				case 35:
					...
					dForm.initAjax();
					addDelformStuff();
					return context$2$0.delegateYield(readUserPosts(), "t22", 39);

				case 39:
					return context$2$0.delegateYield(readFavoritesPosts(), "t23", 40);
