...
(function deMainFuncInner(deWindow, prestoStorage, FormData, scrollTo, localData) {
	...
	var runMain = function () {
		var _ref81 = _asyncToGenerator( regeneratorRuntime.mark(function _callee24(checkDomains, dataPromise) {
			...
			return regeneratorRuntime.wrap(function _callee24$(_context31) {
				while (1) {
					switch (_context31.prev = _context31.next) {
						...
						case 48:
							_context31.prev = 48;
							_context31.t0 = _context31['catch'](43);

							console.error('Delform parsing error:', getErrorMessage(_context31.t0));
							$show(docBody);
							return _context31.abrupt('return');
...
true, true];
					...
					return regeneratorRuntime.wrap(function _callee18$(_context21) {
						while (1) {
							switch (_context21.prev = _context21.next) {
								...
								case 19:
									_context21.t4 = aib.host;
									_context21.t3 = f = _context21.sent[_context21.t4];
					...
					while (1) {
						switch (_context22.prev = _context22.next) {
							case 0:
								...
								return _context22.abrupt('return', this._storage[src]);
					...
					while (1) {
						switch (_context26.prev = _context26.next) {
							...
							case 6:
								...
								num = _ref64.num;
								_context26.t0 = banned;
								_context26.next = _context26.t0 === 1 ? 13 : _context26.t0 === 2 ? 16 : 19;
								break;
							...
							case 15:
								return _context26.abrupt('break', 19);
							...
							case 24:
								...
								_iteratorError29 = _context26.t1;
	...
	function getImageBoard(checkDomains, checkEngines) {
		...
		var Tinyboard = function (_BaseBoard2) {
			...
			_createClass(Tinyboard, [{
				key: 'changeReplyMode',
				value: function () {
					var _ref71 = _asyncToGenerator( regeneratorRuntime.mark(function _callee20(form, tNum) {
						var _this82 = this;
								...
								switch (_context30.prev = _context30.next) {
									case 0:
										...
										data.forEach(function () {
											var _ref76 = _asyncToGenerator( regeneratorRuntime.mark(function _callee22(value, key) {
				...
				value: function init() {
					...
					setTimeout(function () {
						...
						for (var i = 0, _len18 = delPosts.length; i < _len18; ++i) {
							var post = pByNum.get(_this103.getPNum(delPosts[i]));
							if (post) {
		...
		var CrystalCafe = function (_Tinyboard2) {
			...
			function CrystalCafe(prot, dm) {
				...
				var _this105 = _possibleConstructorReturn(this, (CrystalCafe.__proto__ || Object.getPrototypeOf(CrystalCafe)).call(this, prot, dm));

				_this105.qRPost = '.post.reply';
				return _this105;
			}
		...
		var Dscript = function (_TinyIB) {
			...
			function Dscript(prot, dm) {
				...
				var _this108 = _possibleConstructorReturn(this, (Dscript.__proto__ || Object.getPrototypeOf(Dscript)).call(this, prot, dm));

				_this108.markupBB = true;
				_this108.timePattern = 'yy+nn+dd+w+hh+ii+ss';
				return _this108;
			}
	...
	function checkForUpdates(isManual, lastUpdateTime) {
		...
		return $ajax(gitRaw + 'src/modules/Wrap.js', { 'Content-Type': 'text/plain' }, true).then(function (_ref80) {
