...
(function deMainFuncInner(deWindow, scriptStorage, FormData, scrollTo, localData) {
	...
	var checkDelete = function () {
		var _ref42 = _asyncToGenerator( regeneratorRuntime.mark(function _callee14(data) {
		...
		return function checkDelete(_x42) {
				...
				while (1) {
					switch (_context18.prev = _context18.next) {
						...
						case 55:
							...
							return _context18.abrupt('return', $ajax(form.action, ajaxParams).then(function (xhr) {
	...
	var readFile = function () {
		var _ref45 = _asyncToGenerator( regeneratorRuntime.mark(function _callee16(file) {
	...
	var runMain = function () {
		var _ref81 = _asyncToGenerator( regeneratorRuntime.mark(function _callee23(checkDomains, dataPromise) {
			var formEl, favObj, oldMain, _ref82, _ref83, storageName, firstThr;
			...
			return regeneratorRuntime.wrap(function _callee23$(_context30) {
				while (1) {
					switch (_context30.prev = _context30.next) {
						...
						case 47:
							_context30.prev = 47;
							_context30.t0 = _context30['catch'](42);
	...
	function showFavoritesWindow(body, favObj) {
		...
		btns.appendChild($btn(Lng.refresh[lang], Lng.infoCount[lang], _asyncToGenerator( regeneratorRuntime.mark(function _callee5() {
			var favObj, isUpdate, last404, myposts, els, i, len, el, host, _b3, num, _f, _ref9, titleEl, youEl, countEl, iconEl, form, isArchived, _ref10, _ref11, arch, fo, posts, cnt, j, links, a, _len, tc;
	...
	var Pages = {
		addPage: function addPage() {
			...
			this._addingPromise = ajaxLoad(aib.getPageUrl(aib.b, pageNum)).then(function () {
				var _ref24 = _asyncToGenerator( regeneratorRuntime.mark(function _callee10(formEl) {
		...
		loadPages: function () {
			var _ref25 = _asyncToGenerator( regeneratorRuntime.mark(function _callee11(count) {
				...
				}, _callee11, this, [[13, 27, 31, 39], [32,, 34, 38], [42, 51]]);
			}));

			function loadPages(_x34) {
		...
		_updateForms: function () {
			var _ref26 = _asyncToGenerator( regeneratorRuntime.mark(function _callee12(newForm) {
...
true, true];
	...
	var SpellsRunner = function () {
		...
		_createClass(SpellsRunner, [{
			...
			key: '_checkRes',
			value: function _checkRes(post, _ref31) {
				var _ref32 = _slicedToArray(_ref31, 3),
				    hasNumSpell = _ref32[0],
				    val = _ref32[1],
				    msg = _ref32[2];
	...
	var SpellsInterpreter = function () {
		...
		_createClass(SpellsInterpreter, [{
			...
			key: '_ihash',
			value: function () {
				var _ref35 = _asyncToGenerator( regeneratorRuntime.mark(function _callee13(val) {
					...
					}, _callee13, this, [[3, 21, 25, 33], [26,, 28, 32]]);
				}));

				function _ihash(_x37) {
	...
	var PostForm = function () {
		...
		_createClass(PostForm, [{
			...
			value: function _initTextarea() {
				...
				if (nav.isFirefox) {
					el.addEventListener('mouseup', function (_ref36) {
			...
			value: function _makeWindow() {
				...
				buttons.onmouseover = function (_ref37) {
				...
				var _ref38 = [].concat(_toConsumableArray(buttons.children)),
				    clearBtn = _ref38[0],
				    toggleBtn = _ref38[1],
				    closeBtn = _ref38[2];
			...
			value: function setUserPassw() {
				...
				try {
					for (var _iterator22 = DelForm[Symbol.iterator](), _step22; !(_iteratorNormalCompletion22 = (_step22 = _iterator22.next()).done); _iteratorNormalCompletion22 = true) {
						var _ref39 = _step22.value;
						var passEl = _ref39.passEl;
	...
	function getUploadFunc() {
		...
		var _ref40 = [].concat(_toConsumableArray(counterWrap.children)),
		    counterEl = _ref40[0],
		    totalEl = _ref40[1],
		    speedEl = _ref40[2];

		return function (_ref41) {
			var total = _ref41.total,
			    i = _ref41.loaded;
	...
	var Files = function () {
		function Files(form, fileEl) {
			...
			for (var _i36 = 0, len = els.length; _i36 < len; ++_i36) {
				this._inputs.push(new FileInput(this, els[_i36]));
			}
			this._files = [];
			this.hideEmpty();
		}
		...
		_createClass(Files, [{
			...
			value: function hideEmpty() {
				for (var _els3 = this._inputs, _i37 = _els3.length - 1; _i37 > 0; --_i37) {
					var inp = _els3[_i37];
					if (inp.hasFile) {
						break;
					} else if (_els3[_i37 - 1].hasFile) {
						inp.showInp();
						break;
					}
					inp.hideInp();
	...
	var FileInput = function () {
		...
		_createClass(FileInput, [{
					...
					case 'change':
						{
							...
							if (filesLen > 1) {
								(function () {
									...
									var j = allowedLen;
									for (var _i38 = 0; _i38 < allowedLen; ++_i38) {
										FileInput._readDroppedFile(inpArray[curInpIdx + _i38], el.files[_i38]).then(function () {
											if (! --j) {
												_this35._removeFileHelper();
											}
										});
										_this35._parent._files[curInpIdx + _i38] = el.files[_i38];
									}
								})();
							} else {
								setTimeout(function () {
					...
					case 'drop':
						{
							...
							if (_filesLen) {
								...
								for (var _i39 = _inpArray.indexOf(this), j = 0; _i39 < inpLen && j < _filesLen; ++_i39, ++j) {
									FileInput._readDroppedFile(_inpArray[_i39], dt.files[j]);
									this._parent._files[_i39] = dt.files[j];
								}
								DollchanAPI.notify('filechange', this._parent._files);
							} else {
			...
			value: function _onFileChange(hasImgFile) {
				...
				this._parent.hideEmpty();
				if (!nav.isPresto && !aib.fch && /^image\/(?:png|jpeg)$/.test(hasImgFile ? this.imgFile.type : this._input.files[0].type)) {
					$del(this._rarMsg);
					$show(this._btnRar);
				}
			}
					...
					case 'keypress':
						{
							...
							if (Cfg.captchaLang === 1) {
								if (code < 0x0410 || code > 0x04FF || (_i40 = ruUa.indexOf(chr)) === -1) {
									return;
								}
								chr = en[_i40];
							} else {
								if (code < 0x0021 || code > 0x007A || (_i40 = en.indexOf(chr)) === -1) {
									return;
								}
								chr = ruUa[_i40];
							}
			...
			value: function _getFullMsg(truncEl, isInit) {
				...
				ajaxLoad(aib.getThrUrl(aib.b, this.tNum)).then(function (form) {
					...
					if (_this45.isOp) {
						...
						for (var _i41 = 0, len = posts.length; _i41 < len; ++_i41) {
							var post = posts[_i41];
	...
	var Pview = function (_AbstractPost2) {
		...
		function Pview(parent, link, pNum, tNum) {
			...
			_this51._loadPromise = ajaxPostsLoad(_this51.brd, tNum, false).then(function (pBuilder) {
				...
				var html = [];
				for (var _i42 = 0, len = pBuilder.length + 1; _i42 < len; ++_i42) {
					html.push(pBuilder.getPostHTML(_i42 - 1)); 
				}
	...
	var PviewsCache = function (_TemporaryContent2) {
		...
		function PviewsCache(form, b, tNum) {
			...
			for (var _i43 = 0; _i43 < pcount; ++_i43) {
				var post = posts[_i43];
				pByNum.set(aib.getPNum(post), new CacheItem(post, _i43 + 1));
			}
			...
			value: function getFullImg(inPost, onsizechange, onrotate) {
				...
				if (needTitle && !hasTitle) {
					this._webmTitleLoad = ContentLoader.loadImgData(videoEl.src, false).then(function (data) {
						...
						d = d[0];
						for (var _i44 = 0, len = d.length; _i44 < len; ++_i44) {
							if (d[_i44] === 0x49 && d[_i44 + 1] === 0xA9 && d[_i44 + 2] === 0x66 && d[_i44 + 18] === 0x7B && d[_i44 + 19] === 0xA9) {
								_i44 += 20;
								for (var end = (d[_i44++] & 0x7F) + _i44; _i44 < end; ++_i44) {
									str += String.fromCharCode(d[_i44]);
								}
								break;
							}
						}
	...
	var PostImages = function () {
		function PostImages(post) {
			...
			for (var _i45 = 0, len = els.length; _i45 < len; ++_i45) {
				var _el23 = els[_i45];
			...
			if (Cfg.addImgs || localData) {
				...
				for (var _i46 = 0, _len7 = els.length; _i46 < _len7; ++_i46) {
					var _el24 = els[_i46];
	...
	var ImagesHashStorage = Object.create({
		...
		_genImgHash: function _genImgHash(_ref59) {
			...
			var size = oldw * oldh;
			for (var _i47 = 0, j = 0; _i47 < size; _i47++, j += 4) {
				buf[_i47] = buf[j] * 0.3 + buf[j + 1] * 0.59 + buf[j + 2] * 0.11;
			}
			var newh = 8;
			var neww = 8;
			var levels = 3;
			...
			var hash = 0;
			for (var _i48 = 0; _i48 < newh; ++_i48) {
				for (var _j3 = 0; _j3 < neww; ++_j3) {
					var temp = _i48 / (newh - 1) * (oldh - 1);
	...
	function processImgInfoLinks(parent) {
		...
		if (addSrc || imgNames) {
			if (parent instanceof AbstractPost) {
				...
				for (var _i49 = 0, len = _posts.length; _i49 < len; ++_i49) {
					processPostImgInfoLinks(pByEl.get(_posts[_i49]), addSrc, imgNames);
				}
			}
		}
	}
	...
	function embedPostMsgImages(el) {
		...
		for (var _i50 = 0, len = els.length; _i50 < len; ++_i50) {
			var link = els[_i50];
			var _url3 = link.href;
	...
	var DOMPostsBuilder = function () {
		...
		_createClass(DOMPostsBuilder, [{
			...
			value: regeneratorRuntime.mark(function bannedPostsData() {
				var banEls, _i51, len, banEl, postEl;
			...
			value: function gen(posts, thrURL) {
				...
				try {
					for (var _iterator34 = posts[Symbol.iterator](), _step34; !(_iteratorNormalCompletion34 = (_step34 = _iterator34.next()).done); _iteratorNormalCompletion34 = true) {
						...
						for (var lNum, _i52 = 0, len = links.length; _i52 < len; ++_i52) {
							var link = links[_i52];
	...
	var Thread = function () {
		function Thread(el, num, prev, form) {
			...
			for (var _i54 = 0; _i54 < len; ++_i54) {
				var pEl = els[_i54];
				lastPost = new Post(pEl, this, aib.getPNum(pEl), omt + _i54, false, lastPost);
			}
			this.last = lastPost;
		...
		_createClass(Thread, [{
			...
			value: function _importPosts(last, pBuilder, begin, end, maybeVParser, maybeSpells) {
				...
				if (aib.JsonBuilder && nav.hasTemplate) {
					var html = [];
					for (var _i55 = begin; _i55 < end; ++_i55) {
						html.push(pBuilder.getPostHTML(_i55));
						nums.push(pBuilder.getPNum(_i55));
					}
					var temp = doc.createElement('template');
					temp.innerHTML = aib.fixHTML(html.join(''));
					fragm = temp.content;
					var _posts2 = $Q(aib.qRPost, fragm);
					for (var _i56 = 0, _len8 = _posts2.length; _i56 < _len8; ++_i56) {
						last = this._addPost(fragm, _posts2[_i56], begin + _i56 + 1, last, maybeVParser);
			...
			value: function _parsePosts(pBuilder) {
				...
				if (count !== 0 && (aib.dobr || count > len || pBuilder.getPNum(count - 1) !== post.num)) {
					...
					for (; _i57 < len && post;) {
						...
						var iNum = pBuilder.getPNum(_i57);
						if (num === iNum) {
							_i57++;
							post = post.nextNotDeleted;
							continue;
						...
						do {
							cnt++;
							_i57++;
						} while (pBuilder.getPNum(_i57) < num);
						var res = this._importPosts(prev, pBuilder, _i57 - cnt, _i57, maybeVParser, maybeSpells);
						newPosts += res[0];
						this.pcount += res[0];
						newVisPosts += res[1];
	...
	var DelForm = function () {
		function DelForm(formEl, pageNum, prev) {
			...
			for (var _i58 = 0, _len9 = threads.length; _i58 < _len9; ++_i58) {
				var num = aib.getTNum(threads[_i58]);
				if (!DelForm.tNums.has(num)) {
					DelForm.tNums.add(num);
					thr = new Thread(threads[_i58], num, thr, this);
					if (this.firstThr === null) {
						this.firstThr = thr;
					}
					continue;
				}
				var _el26 = threads[_i58];
				var thrNext = threads[_i58 + 1];
	...
	var BaseBoard = function () {
		...
		_createClass(BaseBoard, [{
			...
			value: function fixVideo(isPost, data) {
				...
				for (var _i59 = 0, _len11 = els.length; _i59 < _len11; ++_i59) {
					var _el28 = els[_i59];
	...
	function getImageBoard(checkDomains, checkEngines) {
		...
		var Makaba = function (_BaseBoard) {
			...
			function Makaba(prot, dm) {
				...
				var _this78 = _possibleConstructorReturn(this, (Makaba.__proto__ || Object.getPrototypeOf(Makaba)).call(this, prot, dm));

				_this78.mak = true;

				_this78.cReply = 'post reply post_type_reply';
				_this78.qBan = '.pomyanem, .post__pomyanem';
				_this78.qClosed = '.sticky-img[src$="locked.png"]';
				_this78.qDForm = '#posts-form';
				_this78.qFormFile = 'tr input[type="file"], .postform__raw.filer input[type="file"]';
				_this78.qFormRedir = null;
				_this78.qFormRules = '.rules-area, .rules';
				_this78.qFormSubm = '#submit';
				_this78.qFormTd = 'td, .postform__raw';
				_this78.qFormTr = 'tr, .postform__raw';
				_this78.qFormTxta = '#shampoo';
				_this78.qImgInfo = '.file-attr, .post__file-attr';
				_this78.qOmitted = '.mess-post, .thread__missed';
				_this78.qOPost = '.oppost, .post_type_oppost';
				_this78.qPostHeader = '.post-details, .post__details';
				_this78.qPostImg = '.preview';
				_this78.qPostMsg = '.post-message, .post__message';
				_this78.qPostName = '.ananimas, .post-email, .post__anon, .post__email';
				_this78.qPostRef = '.reflink, .post__reflink:nth-child(2)';
				_this78.qPostSubj = '.post-title, .post__title';
				_this78.qRPost = '.post.reply[data-num], .post.post_type_reply[data-num]';
				_this78.qTrunc = null;

				_this78.formParent = 'thread';
				_this78.hasAltCaptcha = true;
				_this78.hasCatalog = true;
				_this78.hasOPNum = true;
				_this78.hasPicWrap = true;
				_this78.hasReportBtn = true;
				_this78.JsonBuilder = MakabaPostsBuilder;
				_this78.jsonSubmit = true;
				_this78.markupBB = true;
				_this78.multiFile = true;
				_this78.timePattern = 'dd+nn+yy+w+hh+ii+ss';
			...
			_createClass(Makaba, [{
				...
				value: function callReportForm(pNum, tNum) {
					...
					$q('input[type="button"]', $popup('report', '<input name="comment" value="" placeholder="' + Lng.report[lang] + '" type="text"> <input value="OK" type="button">')).onclick = function (e) {
						...
						formData.append('board', _this79.b);
				...
				value: function initCaptcha(cap) {
					...
					if (!img || img.tagName !== 'IMG') {
						...
						var _ref71 = [].concat(_toConsumableArray(box.children)),
						    _img2 = _ref71[0],
						    inp = _ref71[1];

						_img2.onclick = function () {
							return _this80.updateCaptcha(cap);
						};
						inp.tabIndex = 999;
						cap.textEl = inp;
					}
		...
		var Tinyboard = function (_BaseBoard2) {
			...
			_createClass(Tinyboard, [{
				key: 'changeReplyMode',
				value: function () {
					var _ref72 = _asyncToGenerator( regeneratorRuntime.mark(function _callee19(form, tNum) {
						var _this82 = this;
		...
		var Kusaba = function (_BaseBoard3) {
			...
			function Kusaba(prot, dm) {
				...
				var _this85 = _possibleConstructorReturn(this, (Kusaba.__proto__ || Object.getPrototypeOf(Kusaba)).call(this, prot, dm));

				_this85.kus = true;

				_this85.qError = 'h1, h2, div[style*="1.25em"]';
				_this85.qFormRedir = 'input[name="redirecttothread"][value="1"]';

				_this85.formParent = 'replythread';
		...
		var Lynxchan = function (_BaseBoard5) {
			...
			function Lynxchan(prot, dm) {
				...
				var _this87 = _possibleConstructorReturn(this, (Lynxchan.__proto__ || Object.getPrototypeOf(Lynxchan)).call(this, prot, dm));

				_this87.cReply = 'innerPost';
				_this87.qDForm = 'form[action$="contentActions.js"]';
				_this87.qError = '#errorLabel, #labelMessage';
				_this87.qForm = '.form-post, form[action$="newThread.js"], form[action$="replyThread.js"]';
				_this87.qFormPassw = 'input[name="password"]';
				_this87.qFormRules = '.form-post > .small';
				_this87.qFormSubm = '#formButton';
				_this87.qImgInfo = '.uploadDetails';
				_this87.qOmitted = '.labelOmission';
				_this87.qOPost = '.innerOP';
				_this87.qPages = '#divPages';
				_this87.qPostHeader = '.postInfo, .de-post-btns';
			...
			_createClass(Lynxchan, [{
				...
				value: function init() {
					...
					if (el && !$q('td', el)) {
						...
						for (var _i60 = 0, _len12 = _els4.length; _i60 < _len12; ++_i60) {
							$bEnd(table, '<tr><th></th><td></td></tr>').lastChild.appendChild(_els4[_i60]);
						}
					}
					return false;
				}
				...
				key: 'sendHTML5Post',
				value: function () {
					var _ref75 = _asyncToGenerator( regeneratorRuntime.mark(function _callee22(form, data, needProgress, hasFiles) {
						var _this88 = this;

						var getBase64, getCookies, dataObj, files, _i62, _len14, file, cookieObj, ajaxParams;
						...
						return regeneratorRuntime.wrap(function _callee22$(_context29) {
							while (1) {
								switch (_context29.prev = _context29.next) {
									case 0:
										getBase64 = function () {
											var _ref76 = _asyncToGenerator( regeneratorRuntime.mark(function _callee20(file) {
										...
										getCookies = function getCookies() {
											...
											for (var _i61 = 0, _len13 = cookies.length; _i61 < _len13; ++_i61) {
												var parts = cookies[_i61].split('=');
										...
										data.forEach(function () {
											var _ref77 = _asyncToGenerator( regeneratorRuntime.mark(function _callee21(value, key) {
		...
		var FoolFuuka = function (_BaseBoard6) {
			...
			function FoolFuuka(prot, dm) {
				...
				var _this89 = _possibleConstructorReturn(this, (FoolFuuka.__proto__ || Object.getPrototypeOf(FoolFuuka)).call(this, prot, dm));

				_this89.cReply = 'post_wrapper';
				_this89.qDForm = '#main';
				_this89.qImgInfo = '.post_file_metadata, .thread_image_box > .post_file';
				_this89.qOmitted = '.omitted_text';
				_this89.qPages = '.paginate > ul > li:nth-last-child(3)';
				_this89.qPostHeader = 'header';
				_this89.qPostImg = '.post_image, .thread_image';
				_this89.qPostMsg = '.text';
				_this89.qPostRef = '.post_data > a[data-function="quote"]';
				_this89.qPostSubj = '.post_title';
				_this89.qRPost = '.post[id]';

				_this89.docExt = '';
				_this89.firstPage = 1;
				_this89.res = 'thread/';

				_this89._qOPostEnd = '.posts';
				return _this89;
			}
		...
		var Arhivach = function (_BaseBoard10) {
			...
			_createClass(Arhivach, [{
				...
				value: function fixHTML(data, isForm) {
					...
					for (var _i63 = 0, _len15 = links.length; _i63 < _len15; ++_i63) {
						var link = links[_i63];
				...
				value: function init() {
					...
					setTimeout(function () {
						...
						for (var _i64 = 0, _len16 = delPosts.length; _i64 < _len16; ++_i64) {
							var post = pByNum.get(_this101.getPNum(delPosts[_i64]));
							if (post) {
		...
		var Dscript = function (_TinyIB) {
			...
			function Dscript(prot, dm) {
				...
				var _this103 = _possibleConstructorReturn(this, (Dscript.__proto__ || Object.getPrototypeOf(Dscript)).call(this, prot, dm));

				_this103.markupBB = true;
				_this103.timePattern = 'yy+nn+dd+w+hh+ii+ss';
				return _this103;
			}
		...
		var Mewch = function (_Lynxchan2) {
			...
			function Mewch(prot, dm) {
				...
				var _this113 = _possibleConstructorReturn(this, (Mewch.__proto__ || Object.getPrototypeOf(Mewch)).call(this, prot, dm));

				_this113.cReply = 'post';
				_this113.qDForm = '.board-container';
				_this113.qFormFile = 'tr input[type="file"], .dropzone-container';
				_this113.qFormRules = '.message-info';
				_this113.qFormSubm = '.submit-button';
				_this113.qImgInfo = '.post-attachment-info';
				_this113.qOmitted = '.omitted-info';
				_this113.qOPost = '.op';
				_this113.qPages = '.page-links > a:nth-last-of-type(2)';
				_this113.qPostHeader = '.post-info';
				_this113.qPostMsg = '.post-content';
				_this113.qPostRef = '.post-link-reply';
				_this113.qRPost = '.post:not(.op)';
				return _this113;
			}
		...
		var Synch = function (_Tinyboard3) {
			...
			_createClass(Synch, [{
				...
				value: function fixHTML(data, isForm) {
					...
					for (var _i65 = 0, _len17 = els.length; _i65 < _len17; ++_i65) {
						$replace(els[_i65], $q('a', els[_i65]));
					}
					return formEl;
				}
			}, {
		...
		for (var _i67 = ibEngines.length - 1; _i67 >= 0; --_i67) {
			var _ibEngines$_i = _slicedToArray(ibEngines[_i67], 2),
	...
	function checkForUpdates(isManual, lastUpdateTime) {
		...
		return $ajax(gitRaw + 'src/modules/Wrap.js', { 'Content-Type': 'text/plain' }, false).then(function (_ref80) {
			...
			for (var _i68 = 0, _len18 = Math.max(currentVer.length, remoteVer.length); _i68 < _len18; ++_i68) {
				if ((+remoteVer[_i68] || 0) > (+currentVer[_i68] || 0)) {
					return '' + link + Lng.updAvail[lang].replace('%s', v[1]) + '</a>' + chLogLink;
				} else if ((+remoteVer[_i68] || 0) < (+currentVer[_i68] || 0)) {
					break;
				}
			}
			if (isManual) {
	...
	function runFrames() {
		...
		var _loop4 = function _loop4(_i69, _len19) {
			var frameEl = deWindow.frames[_i69].frameElement;
			var fDoc = frameEl.contentDocument;
			if (fDoc) {
		...
		for (var _i69 = 0, _len19 = deWindow.length; _i69 < _len19; ++_i69) {
			_loop4(_i69, _len19);
		}
	}
