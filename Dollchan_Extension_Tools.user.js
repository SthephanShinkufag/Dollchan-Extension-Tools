						...
						while (1) {
							switch (_context17.prev = _context17.next) {
								case 0:
									...
									pByEl.set(pv, this);
									pv.className = aib.cReply + ' de-pview' + (post.isViewed ? ' de-viewed' : '') + (Cfg.markMyPosts && MyPosts.has(num) ? ' de-mypost' : '') + ('' + (post.el.classList.contains('de-mypost-answer') ? ' de-mypost-answer' : ''));
									$show(pv);
