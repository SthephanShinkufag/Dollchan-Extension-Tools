...
function addSettings() {
	...
	], {Class: 'DESU_cfgBody', id: 'DESU_cfgInfo', style: 'height: auto;'}),
...
function scriptCSS() {
	...
	x.push(
		...
		.DESU_cfgBody { min-width: 412px; height: 250px; padding: 11px 7px 7px; margin-top: -1px; font: 13px sans-serif; }\
