...
(function de_main_func_inner(scriptStorage, FormData) {
	...
	function pButton(id) {
		...
		return "<span class=\"de-panel-button\"><a id=\"de-panel-" + id + "\" class=\"de-abtn de-panel-button-inner\" " + (hasHotkey ? "de-" : "") + "title=\"" + Lng.panelBtn[id][lang] + "\" href=\"" + href + "\"></a></span>";
	}
