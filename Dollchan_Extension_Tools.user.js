...
(function deMainFuncInner(scriptStorage, FormData, scrollTo, localData) {
	...
	var Lng = {
		...
		cfg: {
			...
			thrBtns: {
				sel: [['Откл.', 'Все', 'Новые посты'], ['Disable', 'All', 'New posts'], ['Вимк.', 'Всі', 'Нові пости']],
				txt: ['Дополнительные кнопки под тредами', 'Additional buttons under threads', 'Додаткові кнопки під тредами']
			},
