	...
	function getCfgFilters() {
		return $New("div", { "class": "de-cfg-unvis", id: "de-cfg-filters" }, [lBox("hideBySpell", false, toggleSpells), $New("div", { id: "de-spell-panel" }, [$new("a", {
			...
			mouseout: function (_ref) {
				...
				toggleSpells();
			} }), $add("<a href=\"https://github.com/SthephanShinkufag/Dollchan-Extension-Tools/wiki/Spells-" + (lang ? "en" : "ru") + "\" class=\"de-abtn\" target=\"_blank\">[?]</a>")]), $New("div", { id: "de-spell-div" }, [$add("<div id=\"de-spell-rowmeter\"></div>"), $new("textarea", { id: "de-spell-edit", wrap: "off" }, {
