...
(function deMainFuncInner(deWindow, scriptStorage, FormData, scrollTo, localData) {
	...
	var html5Submit = function () {
		var _ref43 = _asyncToGenerator( regeneratorRuntime.mark(function _callee15(form, submitter) {
			...
			var data, hasFiles, _iteratorNormalCompletion23, _didIteratorError23, _iteratorError23, _iterator23, _step23, _ref44, name, value, type, el, val, fileName, newFileName, mime, cleanData, ajaxParams, xhr;
				...
				while (1) {
					switch (_context16.prev = _context16.next) {
						...
						case 25:
							...
							_context16.t2 = el.obj ? el.obj.extraFile : null;
							cleanData = (0, _context16.t0)(_context16.t1, _context16.t2);
							...
							return _context16.abrupt('return', Promise.reject(new Error(Lng.fileCorrupt[lang] + ': ' + fileName)));
						...
						case 40:
							_context16.prev = 40;
							_context16.t3 = _context16['catch'](5);
							_didIteratorError23 = true;
							_iteratorError23 = _context16.t3;
						...
						case 52:
							...
							return _context16.abrupt('return', aib.sendHTML5Post(form, data, needProgress, hasFiles));
						...
						case 63:
							_context16.prev = 63;
							_context16.t4 = _context16['catch'](56);
							return _context16.abrupt('return', Promise.reject(_context16.t4));
			...
			}, _callee15, this, [[5, 40, 44, 52], [45,, 47, 51], [56, 63]]);
		}));
				...
				while (1) {
					switch (_context28.prev = _context28.next) {
						...
						case 47:
							...
							console.error('Delform parsing error:', getErrorMessage(_context28.t0));
							$show(docBody);
							return _context28.abrupt('return');
...
'-',,,,,,,,,,,,, ';', '=', ',', '-', '.', '/', '`',,,,,,,,,,,,,,,,,,,,,,,,,,, '[', '\\', ']', "'"];
	...
	function embedAudioLinks(data) {
		...
		if (Cfg.addVocaroo) {
			...
			for (var _i4 = 0, _len5 = _els2.length; _i4 < _len5; ++_i4) {
				var _link = _els2[_i4];
						...
						while (1) {
							switch (_context11.prev = _context11.next) {
								case 0:
									...
									return _context11.abrupt('return', _this22._updateForms(DelForm.last));
								...
								case 7:
									...
									return _context11.abrupt('return', CancelablePromise.reject(new CancelError()));
					...
					while (1) {
						switch (_context12.prev = _context12.next) {
							...
							case 46:
								...
								_context12.t1._addForm.call(_context12.t1, _context12.t2, _context12.t3);
							...
							case 51:
								...
								$popup('load-pages', getErrorMessage(_context12.t4));
				...
				return regeneratorRuntime.wrap(function _callee12$(_context13) {
					while (1) {
						switch (_context13.prev = _context13.next) {
							case 0:
								_context13.t0 = readPostsData;
								_context13.t1 = newForm.firstThr.op;
								_context13.next = 4;
								return readFavorites();
...
true, true];
		...
		_sort: function _sort(sp) {
			...
			sp = sp.sort();
			for (var _i5 = 0, _len6 = sp.length - 1; _i5 < _len6; ++_i5) {
				var j = _i5 + 1;
				if (sp[_i5][0] === sp[j][0] && sp[_i5][1] <= sp[j][1] && sp[_i5][1] >= sp[j][1] && (sp[_i5][2] === null || 
				sp[_i5][2] === undefined || 
				sp[_i5][2] <= sp[j][2] && sp[_i5][2] >= sp[j][2])) {
					sp.splice(j, 1);
					_i5--;
					_len6--;
				} else if (sp[_i5][0] === 0xFF) {
					sp.push(sp.splice(_i5, 1)[0]);
					_i5--;
					_len6--;
				}
			}
				...
				switch (spellIdx) {
					...
					case 14:
						...
						if (m) {
							var _val = 0;
							var arr = m[1].split(/, */);
							for (var _i6 = 0, len = arr.length; _i6 < len; ++_i6) {
								switch (arr[_i6]) {
									case 'samelines':
										_val |= 1;break;
									case 'samewords':
	...
	var SpellsInterpreter = function () {
		...
		_createClass(SpellsInterpreter, [{
						...
						while (1) {
							switch (_context14.prev = _context14.next) {
								...
								case 5:
									...
									image = _step16.value;
									_context14.t0 = image instanceof AttachedImage;
								...
								case 11:
									...
									_context14.t2 = val;
									_context14.t0 = _context14.t1 === _context14.t2;
								...
								case 21:
									_context14.prev = 21;
									_context14.t3 = _context14['catch'](3);
									_didIteratorError16 = true;
									_iteratorError16 = _context14.t3;
			...
			value: function _wipe(val) {
				...
				if (val & 2) {
					...
					if ((len = arr.length) > 3) {
						...
						var keys = 0;
						var pop = 0;
						for (var _i7 = 0, _n = len / 4; _i7 < len; keys++) {
							x = arr[_i7];
							var _j2 = 0;
							while (arr[_i7++] === x) {
								_j2++;
			...
			value: function _tlenNum_helper(val, num) {
				...
				for (var _arr = val[1], _i9 = _arr.length - 1; _i9 >= 0; --_i9) {
					if (num >= _arr[_i9][0] && num <= _arr[_i9][1]) {
						return true;
					}
				}
				return false;
	...
	var Post = function (_AbstractPost) {
		...
		_createClass(Post, [{
			...
			value: function getPostBtns(isOp, noExpThr) {
				return '<svg class="de-btn-hide"><use class="de-btn-hide-use" xlink:href="#de-symbol-post-hide"/>' + '<use class="de-btn-unhide-use" xlink:href="#de-symbol-post-unhide"/></svg>' + '<svg class="de-btn-rep"><use xlink:href="#de-symbol-post-reply"/></svg>' + (isOp ? (noExpThr ? '' : '<svg class="de-btn-expthr"><use xlink:href="#de-symbol-post-expthr"/></svg>') + '<svg class="de-btn-fav"><use xlink:href="#de-symbol-post-fav"/></svg>' : '');
			}
		}, {
			key: 'findSameText',
						...
						while (1) {
							switch (_context18.prev = _context18.next) {
								...
								case 28:
									...
									pText = '<svg class="de-btn-rep"><use xlink:href="#de-symbol-post-reply"/></svg>' + (isOp ? '<svg class="' + (isFav ? 'de-btn-fav-sel' : 'de-btn-fav') + '">' + '<use xlink:href="#de-symbol-post-fav"></use></svg>' : '') + (post.sage ? '<svg class="de-btn-sage"><use xlink:href="#de-symbol-post-sage"/></svg>' : '') + '<svg class="de-btn-stick"><use xlink:href="#de-symbol-post-stick"/></svg>' + '<span class="de-post-counter' + pCountHtml;
			...
			value: function handleEvent(e) {
				switch (e.type) {
					...
					case 'click':
						{
							var el = e.target;
							if (this.data.isVideo && ExpandableImage.isControlClick(e) || el.tagName !== 'IMG' && el.tagName !== 'VIDEO' && !el.classList.contains('de-fullimg-wrap') && !el.classList.contains('de-fullimg-wrap-link') && !el.classList.contains('de-fullimg-video-hack') && el.className !== 'de-fullimg-load') {
								return;
							}
							if (e.button === 0) {
								if (this._moved) {
	...
	var PostImages = function () {
		function PostImages(post) {
			...
			if (Cfg.addImgs || localData) {
				...
				for (var _i10 = 0, _len7 = els.length; _i10 < _len7; ++_i10) {
					var _el8 = els[_i10];
		...
		if (addSrc || imgNames) {
			if (parent instanceof AbstractPost) {
				...
				for (var i = 0, len = _posts.length; i < len; ++i) {
					processPostImgInfoLinks(pByEl.get(_posts[i]), addSrc, imgNames);
				}
			}
		}
	}
					...
					while (1) {
						switch (_context23.prev = _context23.next) {
							...
							case 6:
								...
								num = _ref64.num;
								_context23.t0 = banned;
								_context23.next = _context23.t0 === 1 ? 13 : _context23.t0 === 2 ? 16 : 19;
								break;
							...
							case 15:
								return _context23.abrupt('break', 19);
							...
							case 24:
								...
								_iteratorError30 = _context23.t1;
		...
		_createClass(Thread, [{
			...
			value: function _importPosts(last, pBuilder, begin, end, maybeVParser, maybeSpells) {
				...
				if (aib.JsonBuilder && nav.hasTemplate) {
					...
					for (var _i12 = 0, _len8 = _posts2.length; _i12 < _len8; ++_i12) {
						last = this._addPost(fragm, _posts2[_i12], begin + _i12 + 1, last, maybeVParser);
	...
	var DelForm = function () {
		function DelForm(formEl, pageNum, prev) {
			...
			for (var i = 0, _len9 = threads.length; i < _len9; ++i) {
	...
	var BaseBoard = function () {
		...
		_createClass(BaseBoard, [{
			...
			value: function fixVideo(isPost, data) {
				...
				for (var i = 0, _len11 = els.length; i < _len11; ++i) {
					var el = els[i];
	...
	function getImageBoard(checkDomains, checkEngines) {
				...
				value: function initCaptcha(cap) {
					...
					if (!img || img.tagName !== 'IMG') {
						...
						_img2.onclick = function () {
							return _this79.updateCaptcha(cap);
						};
						inp.tabIndex = 999;
						cap.textEl = inp;
					}
		...
		var Kusaba = function (_BaseBoard3) {
			...
			function Kusaba(prot, dm) {
				...
				var _this84 = _possibleConstructorReturn(this, (Kusaba.__proto__ || Object.getPrototypeOf(Kusaba)).call(this, prot, dm));

				_this84.kus = true;

				_this84.qError = 'h1, h2, div[style*="1.25em"]';
				_this84.qFormRedir = 'input[name="redirecttothread"][value="1"]';

				_this84.formParent = 'replythread';
								...
								switch (_context27.prev = _context27.next) {
									case 0:
										...
										getCookies = function getCookies() {
											...
											for (var i = 0, _len13 = cookies.length; i < _len13; ++i) {
									...
									case 6:
										...
										_context27.t0 = dataObj.files;
										_context27.t1 = 'data:' + file.type + ';base64,';
										_context27.next = 13;
									...
									case 13:
										...
										_context27.t3 = _context27.t1 + _context27.t2;
										_context27.t4 = file.name;
										_context27.t5 = {
											content: _context27.t3,
											name: _context27.t4,
											spoiler: false
										};

										_context27.t0.push.call(_context27.t0, _context27.t5);
									...
									case 27:
										xhr = _context27.sent;
										return _context27.abrupt('return', xhr.responseText);

									case 31:
										_context27.prev = 31;
										_context27.t6 = _context27['catch'](24);
										return _context27.abrupt('return', Promise.reject(_context27.t6));
		...
		var _02ch = function (_Kusaba) {
			...
			function _02ch(prot, dm) {
				...
				var _this90 = _possibleConstructorReturn(this, (_02ch.__proto__ || Object.getPrototypeOf(_02ch)).call(this, prot, dm));
		...
		var _2chan = function (_BaseBoard8) {
			...
			function _2chan(prot, dm) {
				...
				var _this91 = _possibleConstructorReturn(this, (_2chan.__proto__ || Object.getPrototypeOf(_2chan)).call(this, prot, dm));

				_this91.qDForm = 'form:not([enctype])';
				_this91.qForm = 'form[enctype]';
				_this91.qFormRedir = null;
				_this91.qFormRules = '.chui';
				_this91.qOmitted = 'font[color="#707070"]';
				_this91.qPostImg = 'a[href$=".jpg"] > img, a[href$=".png"] > img, a[href$=".gif"] > img';
				_this91.qPostRef = '.del';
				_this91.qRPost = 'td:nth-child(2)';
		...
		var _2channel = function (_Makaba) {
			...
			function _2channel(prot, dm) {
				...
				var _this92 = _possibleConstructorReturn(this, (_2channel.__proto__ || Object.getPrototypeOf(_2channel)).call(this, prot, dm));

				_this92._2chMoe = true;

				_this92.qFormFile = '.postform__field input[type="file"]';
				_this92.qFormPassw = '#postpasswd';
				_this92.qFormTd = '.postform__field';
				_this92.qFormTr = '.postform__field';

				_this92.hasAltCaptcha = false;
				return _this92;
			}
				...
				value: function updateCaptcha(cap) {
					...
					return cap.updateHelper(url, function (xhr) {
						...
						switch (data.result) {
							case 1:
								{
									var el = $q('.captcha__image');
									var img = $q('img', el) || $aBegin(el, '<img>');
									img.src = '';
		...
		var _410chan = function (_Kusaba2) {
			...
			function _410chan(prot, dm) {
				...
				var _this93 = _possibleConstructorReturn(this, (_410chan.__proto__ || Object.getPrototypeOf(_410chan)).call(this, prot, dm));

				_this93.qFormRedir = 'input#noko';
				_this93.qPages = '.pgstbl > table > tbody > tr > td:nth-child(2)';

				_this93.ru = true;
				_this93.hasCatalog = true;
				_this93.markupBB = false;
				_this93.timePattern = 'dd+nn+yyyy++w++hh+ii+ss';
			...
			_createClass(_410chan, [{
				...
				value: function updateCaptcha(cap) {
					...
					return cap.updateHelper('/api_adaptive.php?board=' + this.b, function (xhr) {
						...
						var src = img.getAttribute('src');
						img.src = '';
						img.src = _this94.getCaptchaSrc(src);
					});
				}
			}, {
				key: 'capLang',
		...
		var _4chan = function (_BaseBoard9) {
			...
			function _4chan(prot, dm) {
				...
				var _this95 = _possibleConstructorReturn(this, (_4chan.__proto__ || Object.getPrototypeOf(_4chan)).call(this, prot, dm));

				_this95.fch = true;

				_this95.cReply = 'post reply';
				_this95.qBan = 'strong[style="color: red;"]';
				_this95.qClosed = '.archivedIcon';
				_this95.qDelBut = '.deleteform > input[type="submit"]';
				_this95.qError = '#errmsg';
				_this95.qForm = 'form[name="post"]';
				_this95.qFormRedir = null;
				_this95.qImgInfo = '.fileText';
				_this95.qOmitted = '.summary.desktop';
				_this95.qOPost = '.op';
				_this95.qPages = '.pagelist > .pages:not(.cataloglink) > a:last-of-type';
				_this95.qPostHeader = '.postInfo';
				_this95.qPostImg = '.fileThumb > img:not(.fileDeletedRes)';
				_this95.qPostName = '.name';
				_this95.qPostRef = '.postInfo > .postNum';
				_this95.qPostSubj = '.subject';

				_this95.anchor = '#p';
				_this95.docExt = '';
				_this95.firstPage = 1;
				_this95.formParent = 'resto';
				_this95.hasAltCaptcha = true;
				_this95.hasCatalog = true;
				_this95.hasTextLinks = true;
				_this95.JsonBuilder = _4chanPostsBuilder;
				_this95.res = 'thread/';
				_this95.timePattern = 'nn+dd+yy+w+hh+ii-?s?s?';

				_this95._qOPostEnd = '.replyContainer';
				return _this95;
			}
		...
		var _8ch = function (_Vichan) {
			...
			function _8ch(prot, dm) {
				...
				var _this96 = _possibleConstructorReturn(this, (_8ch.__proto__ || Object.getPrototypeOf(_8ch)).call(this, prot, dm));
		...
		var _55chan = function (_ch) {
			...
			function _55chan(prot, dm) {
				...
				var _this97 = _possibleConstructorReturn(this, (_55chan.__proto__ || Object.getPrototypeOf(_55chan)).call(this, prot, dm));

				_this97._8ch = null;

				_this97.qFormRules = '.regras';
				return _this97;
			}
		...
		var Arhivach = function (_BaseBoard10) {
			...
			function Arhivach(prot, dm) {
				...
				_this99.qRPost = '.post:not(:first-child):not([postid=""])';
			...
			_createClass(Arhivach, [{
				...
				value: function fixHTML(data, isForm) {
					...
					for (var i = 0, _len15 = links.length; i < _len15; ++i) {
						var link = links[i];
		...
		var Brchan = function (_Vichan2) {
			...
			function Brchan(prot, dm) {
				...
				var _this101 = _possibleConstructorReturn(this, (Brchan.__proto__ || Object.getPrototypeOf(Brchan)).call(this, prot, dm));
		...
		var Dscript = function (_TinyIB) {
			...
			function Dscript(prot, dm) {
				...
				var _this102 = _possibleConstructorReturn(this, (Dscript.__proto__ || Object.getPrototypeOf(Dscript)).call(this, prot, dm));

				_this102.markupBB = true;
				_this102.timePattern = 'yy+nn+dd+w+hh+ii+ss';
				return _this102;
			}
		...
		var Mewch = function (_Lynxchan2) {
			...
			function Mewch(prot, dm) {
				...
				var _this112 = _possibleConstructorReturn(this, (Mewch.__proto__ || Object.getPrototypeOf(Mewch)).call(this, prot, dm));

				_this112.cReply = 'post';
				_this112.qDForm = '.board-container';
				_this112.qFormFile = 'tr input[type="file"], .dropzone-container';
				_this112.qFormRules = '.message-info';
				_this112.qFormSubm = '.submit-button';
				_this112.qImgInfo = '.post-attachment-info';
				_this112.qOmitted = '.omitted-info';
				_this112.qOPost = '.op';
				_this112.qPages = '.page-links > a:nth-last-of-type(2)';
				_this112.qPostHeader = '.post-info';
				_this112.qPostMsg = '.post-content';
				_this112.qPostRef = '.post-link-reply';
				_this112.qRPost = '.post:not(.op)';
				return _this112;
			}
		...
		var Synch = function (_Tinyboard3) {
			...
			_createClass(Synch, [{
				...
				value: function fixHTML(data, isForm) {
					...
					for (var i = 0, _len17 = els.length; i < _len17; ++i) {
		...
		for (var _i13 = ibEngines.length - 1; _i13 >= 0; --_i13) {
			var _ibEngines$_i = _slicedToArray(ibEngines[_i13], 2),
	...
	function checkForUpdates(isManual, lastUpdateTime) {
		...
		return $ajax(gitRaw + 'src/modules/Wrap.js', { 'Content-Type': 'text/plain' }, false).then(function (_ref80) {
			...
			if (remoteVer) {
				...
				for (var i = 0, _len18 = Math.max(currentVer.length, remoteVer.length); i < _len18; ++i) {
	...
	function runFrames() {
		...
		for (var i = 0, _len19 = deWindow.length; i < _len19; ++i) {
			_loop2(i, _len19);
		}
	}
