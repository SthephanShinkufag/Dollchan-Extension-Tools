...
true, true];
	...
	function getImageBoard(checkDomains, checkEngines) {
		...
		var Tinyboard = function (_BaseBoard) {
			_inherits(Tinyboard, _BaseBoard);
		...
		var Kusaba = function (_BaseBoard2) {
			_inherits(Kusaba, _BaseBoard2);
