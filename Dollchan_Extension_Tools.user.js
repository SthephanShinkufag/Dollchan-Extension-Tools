...
(function de_main_func_inner(scriptStorage, FormData) {
	...
	function getCfgInfo() {
		...
		return $New("div", { "class": "de-cfg-unvis", id: "de-cfg-info" }, [$add("<div style=\"padding-bottom: 10px;\">" + "<a href=\"https://github.com/SthephanShinkufag/Dollchan-Extension-Tools/wiki/versions\" " + "target=\"_blank\">v" + version + "." + commit + "</a>&nbsp;|&nbsp;" + "<a href=\"http://www.freedollchan.org/scripts/\" target=\"_blank\">Freedollchan</a>&nbsp;|&nbsp;" + "<a href=\"https://github.com/SthephanShinkufag/Dollchan-Extension-Tools/wiki/" + (lang ? "home-en/" : "") + "\" target=\"_blank\">Github</a></div>"), $add("<div id=\"de-info-table\"><div>" + "<div><span>" + Lng.thrViewed[lang] + "</span><span>" + Cfg.stats.view + "</span></div>" + "<div><span>" + Lng.thrCreated[lang] + "</span><span>" + Cfg.stats.op + "</span></div>" + "<div><span>" + Lng.thrHidden[lang] + "</span><span>" + getHiddenThrCount() + "</span></div>" + "<div><span>" + Lng.postsSent[lang] + "</span><span>" + Cfg.stats.reply + "</span></div></div>" + "<div style=\"overflow-y: auto; border-left: 1px solid grey;\">" + new Logger().getTable() + "</div></div>"), $btn(Lng.debug[lang], Lng.infoDebug[lang], function () {
