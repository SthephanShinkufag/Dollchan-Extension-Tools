...
function scriptCSS() {
	...
	function gif(id, src) {
		return id + ' { background-image: url(data:image/gif;base64,' + src + '); }';
	}
	...
	#de-panel-logo { flex: none; margin-right: 3px; cursor: pointer; min-height: 25px; width: 25px; background-repeat: no-repeat; background-position: center; }\
